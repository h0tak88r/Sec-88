...
* [Methodologies - Checklists](methodologies-checklists/README.md)
  ...
  * [Web Services Based Checklist](methodologies-checklists/web-services-based-checklist.md)
...
* [Web-AppSec](web-appsec/README.md)
  * [Industry Based Checklist](web-appsec/industry-based-checklist/README.md)
    ...
    * [Testing localization - Translation WebApps](web-appsec/industry-based-checklist/testing-localization-translation-webapps.md)
  * [Services Based Pentest Checklist](web-appsec/services-based-pentest-checklist.md)
  * [Features Abuse Checklist](web-appsec/features-abuse/README.md)
    ...
    * [Change Name Feature](web-appsec/features-abuse/change-name-feature.md)
    * [Change Phone Numbers](web-appsec/features-abuse/change-phone-numbers.md)
    * [Logout Feature](web-appsec/features-abuse/logout-feature.md)
    ...
    * [Addresses Management](web-appsec/features-abuse/billing-shipping-address-management.md)
  ...
  * [Reconnaissance](web-appsec/reconnaissance/README.md)
    * [Subdomain Enumeration](web-appsec/reconnaissance/web-app-security.md)
    * [Dorking](web-appsec/reconnaissance/information-disclosure.md)
    * [Fingerprinting](web-appsec/reconnaissance/fingerprinting.md)
  ...
  * [OAUTH Misconfigurations](web-appsec/oauth-misconfigurations/README.md)
    ...
    * [Custom SSO Logins](web-appsec/oauth-misconfigurations/custom-sso-logins.md)
  ...
  * [Next.js middleware CP - DOS](web-appsec/next.js-middleware-cp-dos.md)
  ...
  * [ASP.NET Security Testing](web-appsec/asp.net-security-testing.md)
...
* [Android-AppSec](android-appsec/README.md)
  ...
  * [Intercepting Cellular Android Traffic via Mobile Data and Ngrok](android-appsec/intercepting-cellular-android-traffic-via-mobile-data-and-ngrok.md)
  ...
  * [Decompile a Hermes React Native Binary](android-appsec/decompile-a-hermes-react-native-binary.md)
  * [Get APK for Target](android-appsec/how-to-get-apk-file-for-application.md)
...
* [IOS-AppSec](ios-appsec/README.md)
  * [iOS Device/Simulator Setup](ios-appsec/ios-device-simulator-setup.md)
  * [Understanding iOS Security Basics](ios-appsec/understanding-ios-security-basics.md)
  * [iOS Pentesting Environment Setup](ios-appsec/ios-pentesting-environment-setup.md)
  ...
  * [How to GET/PULL/Install IPA](ios-appsec/how-to-get-pull-install-ipa.md)
  ...
  * [IOS Reverse Engineering](ios-appsec/ios-reverse-engineering.md)
...
* [Write-Ups](write-ups/README.md)
  * [Discord OAuth Misconfig → ATO, Pre-ATO & 2FA Bypass](write-ups/discord-oauth-misconfig-ato-pre-ato-and-2fa-bypass.md)
  ...
  * [Semi-Automating My Android Bug Hunting Flow with apkX](write-ups/semi-automating-my-android-bug-hunting-flow-with-apkx.md)
  * [Using N8N To Orchestrate Web and Mobile Bug Hunting](write-ups/using-n8n-to-orchestrate-web-and-mobile-bug-hunting.md)
  * [Hacking Android Labs](write-ups/hacking-labs/README.md)

# How I Turned a Medium XSS into a High Bounty by Bypassing HttpOnly Cookie
...
By creatively bypassing the limitations of the initial vulnerability, I was able to escalate its impact from medium to high severity. This case highlights the importance of thoroughly exploring vulnerabilities, even when they seem limited at first glance. It also underscores the need for robust security measures, such as proper input validation, output encoding, and secure cookie handling, to mitigate the risks of XSS attacks.
